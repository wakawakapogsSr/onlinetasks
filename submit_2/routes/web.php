...
Route::get('/testlogin', 'open_user_reg\AuthenticationController@login');
Route::get('/user_register ', 'open_user_reg\AuthenticationController@register');
Route::post('/user_register ', 'open_user_reg\AuthenticationController@register_post');
